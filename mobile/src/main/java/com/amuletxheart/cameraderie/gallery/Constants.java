 ...
 *******************************************************************************/
package com.amuletxheart.cameraderie.gallery;
...
public final class Constants {
	...
	public static final String[] IMAGES = new String[] {
			...
			"http://4.bp.blogspot.com/-LEvwF87bbyU/Uicaskm-g6I/AAAAAAAAZ2c/V-WZZAvFg5I/s800/Pesto+Guacamole+500w+0268.jpg", // ImageContainer with "Mark has been invalidated" problem
			"file:///sdcard/Universal ImageContainer Loader @#&=+-_.,!()~'%20.png", // ImageContainer from SD card with encoded symbols
			"assets://Living Things @#&=+-_.,!()~'%20.jpg", // ImageContainer from assets
			"drawable://" + R.drawable.ic_launcher, // ImageContainer from drawables
			"http://upload.wikimedia.org/wikipedia/ru/b/b6/Как_кот_с_мышами_воевал.png", // Link with UTF-8
			"https://www.eff.org/sites/default/files/chrome150_0.jpg", // ImageContainer from HTTPS
	...
	public static class Extra {
        ...
        public static final String IMAGE_CONTAINER = "com.amuletxheart.cameraderie.IMAGE_CONTAINER";
